      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-6">
            <Link href="mailto:hello@menulink.com" className="flex items-center text-gray-400 hover:text-white transition-colors">
              <Mail className="h-5 w-5 mr-2" /> hello@menulink.com
            </Link>
            <Link href="tel:+18005551234" className="flex items-center text-gray-400 hover:text-white transition-colors">
